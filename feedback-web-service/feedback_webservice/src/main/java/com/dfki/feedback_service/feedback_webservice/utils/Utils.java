package com.dfki.feedback_service.feedback_webservice.utils;
...
public class Utils {
    ...
    public static NearByStops convertTurtleToNearByStops(String turtle, String rdfFormat) {
    ...
    public static Stop convertTurtleToStop(String turtle, String rdfFormat) {
        Stop stop = new Stop();
        Model model = ModelFactory.createDefaultModel();
        InputStream stream = new ByteArrayInputStream(turtle.getBytes());
        model.read(stream, null, rdfFormat);
